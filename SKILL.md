...
stage_contract:
  upper:
    ...
    hero_architecture: approximately-70-percent-photographic-plus-20-35-percent-colored-partial-sketch
...
- **Architecture:** globally preserve the same building identity, building count/range, landmark-defining profile, and recognition-critical relationships. Apply exact façade/perspective alignment and the 70/30 partial-sketch balance only to the upper hero. The lower may spatially re-author architecture as extreme semantic reconstruction without inventing or substituting structures.
...
architecture_stage_plan: [<hero identity -> upper 70/30 colored partial sketch; lower extreme semantic reconstruction>]
...
lower_primary_person: none | readable-abstract-human-silhouette
...
upper_architectural_sketch_zone: <one concentrated contiguous zone on the upper primary hero; target 20-35% of visible hero body; no scattered edge marks>
...
stage_treatment_matrix:
  primary_person:
    ...
    lower: readable-abstract-human-silhouette
  secondary_people:
    upper: one-shared-opaque-flat-silhouette
    lower: simplified-grouped-semantic-masses-or-shared-flat-silhouettes
  hero_architecture:
    upper: approximately-70-percent-photographic-plus-20-35-percent-colored-partial-sketch
...
For the upper primary architectural hero, preserve approximately 70% photographic reality and convert 20–35% into a colored hand-drawn architectural study, with 30% preferred. Communicate partial non-completion through structural omissions and interrupted construction, not merely surface linework. Upper secondary architecture does not receive this balance. In the lower stage, reconstruct the same architecture almost entirely non-photographically using its minimum recognition skeleton, source-derived structural relationships, broad color planes, and sparse lines; do not preserve a 70% photographic body.
...
upper_architecture_priority:
  ...
  4: approximately-70-percent-photographic-reality
  5: approximately-30-percent-colored-partial-sketch-deconstruction
...
- **Lower `readable-abstract-human-silhouette`:** prohibit realistic face, skin texture, facial features, hair strands, garment microdetail, and photographic shading. Preserve a clearly human silhouette, approximate source pose, orientation, gesture, head/torso/limb relationship, recognizable body rhythm, and scene relationship using 2–5 broad planes or a sparse contour system. The approximately 95% facial target does not apply to the lower stage.
...
4. In the default four-band layout, center the title in the black band below the upper board and the subtitle in the black band below the lower panel.
...
- **`A03 upper-photographic-corridor`:** no uncontrolled continuous upper environmental photographic corridor exceeds 35% of the full upper artwork area; exclude the primary-face identity region and upper hero architecture governed by its 70/30 rule. Do not apply this gate to lower.
...
- **`L01 upper-landmark-generic`:** the upper hero must retain decisive identifiers while converting one concentrated 20–35% region into a culturally appropriate colored sketch. Lower is evaluated by semantic identity and minimum recognition skeleton, not this balance.
...
- **`V02 upper-architectural-balance-failure`:** the upper hero architecture does not retain approximately 70% photographic reality plus one concentrated 20–35% colored partial-sketch zone. Never apply this gate to lower architecture, which should be extremely reconstructed.
...
- **`T02 typography-failure`:** in processed, title and subtitle are exact, centered, legible, refined, subordinate warm-white serif copy inside their dedicated black bands; no date or artwork-position search is permitted. In fullbleed, keep selected copy subordinate and source-aware without covering critical evidence.
